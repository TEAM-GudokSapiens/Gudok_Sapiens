...
urlpatterns = [
    ...
    path('list/lifestyle/laundry/', views.subcategory_laundry, name='subcategory_laundry'),
    ...
    path('list/food/fastfood/', views.subcategory_fastfood, name='subcategory_fastfood'),
